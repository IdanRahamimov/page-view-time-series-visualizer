...
def draw_line_plot():
    ...
    ax.xaxis.set_major_locator( plticker.MultipleLocator(base=150.0)) 
...
def draw_bar_plot():
    ...
    df_bar = df.groupby(pd.Grouper(freq="M")).mean().round()
...
def draw_box_plot():
  ...
  # Draw box plots (using Seaborn)
    ...
    sns.boxplot(data=df_box, x=df_box['month'], y=df_box['value'], ax=ax[1], order=order)
